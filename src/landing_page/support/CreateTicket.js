    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                   <h4 className="mb-5"><i class="fa fa-user-o" aria-hidden="true"></i> Your Account</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                   <h4 className="mb-5"><i class="fa fa-exchange" aria-hidden="true"></i> Trading & Markets</h4>
                ...
                <div className="col-4 p-5 mb-2">
                   <h4 className="mb-5"><i class="fa fa-envelope-open-o" aria-hidden="true"></i> Funds</h4>
                ...
                <div className="col-4 p-5 mb-2">
                   <h4 className="mb-5"><i class="fa fa-codiepie" aria-hidden="true"></i> Console</h4>
                ...
                <div className="col-4 p-5 mb-2">
                   <h4 className="mb-5"><i class="fa fa-ravelry" aria-hidden="true"></i> Coin</h4>
                   <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Mutual funds and Coin</a>
                   <br />
